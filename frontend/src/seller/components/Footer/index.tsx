...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp dark:bg-[#FFFFFF] relative z-10 bg-[#FFFFFF] pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="container">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-[#000000]"
                  >
                    <svg
                      width="9"
                      height="18"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/blogs"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-[#000000]"
                    >
                      Blog
                    </a>
                  </li>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-black">
              @2024 All Rights Reservered. Designed by {" "}
